...
package pdfaextension ;import (_e "fmt";_a "github.com/unidoc/go-xmp/models/dc";_db "github.com/unidoc/go-xmp/models/pdf";_g "github.com/unidoc/go-xmp/models/xmp_base";_bd "github.com/unidoc/go-xmp/models/xmp_mm";_f "github.com/unidoc/go-xmp/xmp";_da "reflect";
_df "sort";_c "strings";_b "sync";);

// SyncFromXMP implements xmp.Model interface.
func (_gbc *Model )SyncFromXMP (d *_f .Document )error {return nil };func init (){_f .Register (Namespace ,_f .XmpMetadata );_f .Register (SchemaNS );_f .Register (PropertyNS );_f .Register (ValueTypeNS );_f .Register (FieldNS );};
...
func (_dbg *PropertyCategory )UnmarshalText (in []byte )error {switch string (in ){case "\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c":*_dbg =PropertyCategoryInternal ;case "\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c":*_dbg =PropertyCategoryExternal ;
default:*_dbg =PropertyCategoryUndefined ;};return nil ;};func _ce (_dbf _f .Model ,_ac *_f .Namespace ,_cg Property )bool {_ad :=_da .ValueOf (_dbf ).Elem ();if _ad .Kind ()==_da .Ptr {_ad =_ad .Elem ();};_bc :=_ad .Type ();for _ceg :=0;_ceg < _bc .NumField ();
_ceg ++{_ff :=_bc .Field (_ceg );_dgb :=_ff .Tag .Get ("\u0078\u006d\u0070");if _dgb ==""{continue ;};if !_c .HasPrefix (_dgb ,_ac .Name ){continue ;};_gd :=_c .IndexRune (_dgb ,':');if _gd ==-1{continue ;};_dcb :=_dgb [_gd +1:];if _dcb ==_cg .Name {_fad :=_ad .Field (_ceg );
return !_fad .IsZero ();};};return false ;};

// AltOfValueTypeName gets the ValueTypeName of the alt of given value type names.
func AltOfValueTypeName (vt ValueTypeName )ValueTypeName {return "\u0061\u006c\u0074\u0020"+vt };const (PropertyCategoryUndefined PropertyCategory =iota ;PropertyCategoryInternal ;PropertyCategoryExternal ;);const (ValueTypeResourceEvent ValueTypeName ="\u0052\u0065\u0073\u006f\u0075\u0072\u0063\u0065\u0045\u0076\u0065\u006e\u0074";
);

// MarshalText implements encoding.TextMarshaler interface.
func (_bb PropertyCategory )MarshalText ()([]byte ,error ){switch _bb {case PropertyCategoryInternal :return []byte ("\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;case PropertyCategoryExternal :return []byte ("\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;
case PropertyCategoryUndefined :return []byte (""),nil ;default:return nil ,_e .Errorf ("\u0075\u006ed\u0065\u0066\u0069\u006ee\u0064\u0020p\u0072\u006f\u0070\u0065\u0072\u0074\u0079\u0020c\u0061\u0074\u0065\u0067\u006f\u0072\u0079\u0020\u0076\u0061\u006c\u0075e\u003a\u0020\u0025\u0076",_bb );
};};

// SyncModel implements xmp.Model interface.
func (_ccf *Model )SyncModel (d *_f .Document )error {return nil };

// SetTag implements xmp.Model interface.
func (_gba *Model )SetTag (tag ,value string )error {if _ba :=_f .SetNativeField (_gba ,tag ,value );_ba !=nil {return _e .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_ba );};return nil ;};var (Namespace =_f .NewNamespace ("\u0070\u0064\u0066\u0061\u0045\u0078\u0074\u0065\u006e\u0073\u0069\u006f\u006e","\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067\u002f\u0070\u0064\u0066\u0061/\u006e\u0073\u002f\u0065\u0078t\u0065\u006es\u0069\u006f\u006e\u002f",NewModel );
...
func GetSchema (namespaceURI string )(*Schema ,bool ){_ab .RLock ();defer _ab .RUnlock ();_caa ,_dfb :=_acf [namespaceURI ];return _caa ,_dfb ;};

// Schemas is the array of xmp metadata extension resources.
type Schemas []Schema ;

// NewModel creates a new pdfAExtension model.
func NewModel (name string )_f .Model {return &Model {}};var XmpIDQualSchema =Schema {NamespaceURI :"\u0068t\u0074\u0070:\u002f\u002f\u006e\u0073.\u0061\u0064\u006fb\u0065\u002e\u0063\u006f\u006d\u002f\u0078\u006d\u0070/I\u0064\u0065\u006et\u0069\u0066i\u0065\u0072\u002f\u0071\u0075\u0061l\u002f\u0031.\u0030\u002f",Prefix :"\u0078\u006d\u0070\u0069\u0064\u0071",Schema :"X\u004dP\u0020\u0078\u006d\u0070\u0069\u0064\u0071\u0020q\u0075\u0061\u006c\u0069fi\u0065\u0072",Property :[]Property {{Category :PropertyCategoryInternal ,Name :"\u0053\u0063\u0068\u0065\u006d\u0065",Description :"\u0041\u0020\u0071\u0075\u0061\u006c\u0069\u0066\u0069\u0065\u0072\u0020\u0070\u0072o\u0076\u0069\u0064i\u006e\u0067\u0020\u0074h\u0065\u0020\u006e\u0020\u0061\u006d\u0065\u0020\u006f\u0066\u0020\u0074\u0068\u0065\u0020\u0066\u006f\u0072\u006d\u0061\u006c \u0069\u0064\u0065n\u0074\u0069\u0066\u0069\u0063\u0061\u0074\u0069\u006f\u006e\u0020\u0073\u0063\u0068\u0065\u006d\u0065\u0020\u0075\u0073ed\u0020\u0066\u006fr\u0020\u0061\u006e\u0020\u0069\u0074\u0065\u006d \u0069\u006e\u0020\u0074\u0068\u0065\u0020\u0078\u006d\u0070\u003a\u0049\u0064\u0065\u006e\u0074\u0069\u0066\u0069\u0065\u0072\u0020\u0061\u0072\u0072\u0061\u0079\u002e",ValueType :ValueTypeNameText }},ValueType :nil };


// CanTag implements xmp.Model interface.
func (_egg *Model )CanTag (tag string )bool {_ ,_fg :=_f .GetNativeField (_egg ,tag );return _fg ==nil };func init (){_acf =map[string ]*Schema {_bd .NsXmpMM .URI :&XmpMediaManagementSchema ,"\u0078\u006d\u0070\u0069\u0064\u0071":&XmpIDQualSchema ,_db .NsPDF .URI :&PdfSchema ,"\u0073\u0074\u0045v\u0074":&FieldResourceEventSchema ,"\u0073\u0074\u0056e\u0072":&FieldVersionSchema };
};

// RegisterSchema registers schema extension definition.
func RegisterSchema (ns *_f .Namespace ,schema *Schema ){_ab .Lock ();defer _ab .Unlock ();_acf [ns .URI ]=schema ;};const (ValueTypeNameBoolean ValueTypeName ="\u0042o\u006f\u006c\u0065\u0061\u006e";ValueTypeNameDate ValueTypeName ="\u0044\u0061\u0074\u0065";
...
func (_ddd *ValueTypes )UnmarshalXMP (d *_f .Decoder ,node *_f .Node ,m _f .Model )error {return _f .UnmarshalArray (d ,node ,_ddd .Typ (),_ddd );};

// Typ gets the array type of the value types.
func (_gbf ValueTypes )Typ ()_f .ArrayType {return _f .ArrayTypeOrdered };
...
func (_ee Properties )Typ ()_f .ArrayType {return _f .ArrayTypeOrdered };

// GetTag implements xmp.Model interface.
func (_gec *Model )GetTag (tag string )(string ,error ){_ea ,_dbb :=_f .GetNativeField (_gec ,tag );if _dbb !=nil {return "",_e .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_dbb );};return _ea ,nil ;};

// MarshalXMP implements xmp.Marshaler interface.
func (_fe Properties )MarshalXMP (e *_f .Encoder ,node *_f .Node ,m _f .Model )error {return _f .MarshalArray (e ,node ,_fe .Typ (),_fe );};
...
func MakeModel (d *_f .Document )(*Model ,error ){_fc ,_cc :=d .MakeModel (Namespace );if _cc !=nil {return nil ,_cc ;};return _fc .(*Model ),nil ;};func (_ffd Schemas )Typ ()_f .ArrayType {return _f .ArrayTypeUnordered };

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_ae *Schemas )UnmarshalXMP (d *_f .Decoder ,node *_f .Node ,m _f .Model )error {return _f .UnmarshalArray (d ,node ,_ae .Typ (),_ae );};

// FillModel fills in the document XMP model.
func FillModel (d *_f .Document ,extModel *Model )error {var _gc []*_f .Namespace ;for _ ,_fcc :=range d .Namespaces (){_gc =append (_gc ,_fcc );};_df .Slice (_gc ,func (_ccg ,_bf int )bool {return _gc [_ccg ].Name < _gc [_bf ].Name });for _ ,_ga :=range _gc {switch _ga {case Namespace ,SchemaNS ,PropertyNS ,ValueTypeNS ,FieldNS ,_g .NsXmp ,_a .NsDc :continue ;
default:_ca ,_dc :=GetSchema (_ga .URI );if !_dc {continue ;};_ec :=d .FindModel (_ga );_ge :=*_ca ;_ge .Property =Properties {};for _ ,_eg :=range _ca .Property {_ag :=_ce (_ec ,_ga ,_eg );if _ag {_ge .Property =append (_ge .Property ,_eg );};};if len (_ge .Property )==0{continue ;
};var _dfa bool ;for _gb ,_dbc :=range extModel .Schemas {if _dbc .Schema ==_ge .Schema {_dfa =true ;extModel .Schemas [_gb ]=_ge ;break ;};};if !_dfa {extModel .Schemas =append (extModel .Schemas ,_ge );};};};return nil ;};

// IsZero checks if the resources list has no entries.
func (_efd Schemas )IsZero ()bool {return len (_efd )==0};

// Namespaces implements xmp.Model interface.
func (_ffa *Model )Namespaces ()_f .NamespaceList {return _f .NamespaceList {Namespace }};
...
func (_dfaf *Model )SyncToXMP (d *_f .Document )error {return nil };
...
// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_gac *Properties )UnmarshalXMP (d *_f .Decoder ,node *_f .Node ,m _f .Model )error {return _f .UnmarshalArray (d ,node ,_gac .Typ (),_gac );};
...
// MarshalXMP implements xmp.Marshaler interface.
func (_ead Schemas )MarshalXMP (e *_f .Encoder ,node *_f .Node ,m _f .Model )error {return _f .MarshalArray (e ,node ,_ead .Typ (),_ead );};
...
// MarshalXMP implements xmp.Marshaler interface.
func (_eed ValueTypes )MarshalXMP (e *_f .Encoder ,node *_f .Node ,m _f .Model )error {return _f .MarshalArray (e ,node ,_eed .Typ (),_eed );};