...
package pdfaextension ;import (_b "fmt";_dg "github.com/trimmer-io/go-xmp/models/dc";_bf "github.com/trimmer-io/go-xmp/models/pdf";_gd "github.com/trimmer-io/go-xmp/models/xmp_base";_g "github.com/trimmer-io/go-xmp/models/xmp_mm";_ffb "github.com/trimmer-io/go-xmp/xmp";
_d "reflect";_a "sort";_ff "strings";_e "sync";);var (Namespace =_ffb .NewNamespace ("\u0070\u0064\u0066\u0061\u0045\u0078\u0074\u0065\u006e\u0073\u0069\u006f\u006e","\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067\u002f\u0070\u0064\u0066\u0061/\u006e\u0073\u002f\u0065\u0078t\u0065\u006es\u0069\u006f\u006e\u002f",NewModel );
SchemaNS =_ffb .NewNamespace ("\u0070\u0064\u0066\u0061\u0053\u0063\u0068\u0065\u006d\u0061","h\u0074\u0074\u0070\u003a\u002f\u002fw\u0077\u0077\u002e\u0061\u0069\u0069m\u002e\u006f\u0072\u0067\u002f\u0070\u0064f\u0061\u002f\u006e\u0073\u002f\u0073\u0063\u0068\u0065\u006da\u0023",nil );
PropertyNS =_ffb .NewNamespace ("\u0070\u0064\u0066a\u0050\u0072\u006f\u0070\u0065\u0072\u0074\u0079","\u0068\u0074t\u0070\u003a\u002f\u002fw\u0077\u0077.\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067/\u0070\u0064\u0066\u0061\u002f\u006e\u0073\u002f\u0070\u0072\u006f\u0070e\u0072\u0074\u0079\u0023",nil );
ValueTypeNS =_ffb .NewNamespace ("\u0070\u0064\u0066\u0061\u0054\u0079\u0070\u0065","\u0068\u0074\u0074\u0070\u003a\u002f/\u0077\u0077\u0077\u002e\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067\u002fp\u0064\u0066\u0061\u002f\u006e\u0073\u002ft\u0079\u0070\u0065\u0023",nil );
FieldNS =_ffb .NewNamespace ("\u0070d\u0066\u0061\u0046\u0069\u0065\u006cd","\u0068\u0074\u0074p:\u002f\u002f\u0077\u0077\u0077\u002e\u0061\u0069\u0069m\u002eo\u0072g\u002fp\u0064\u0066\u0061\u002f\u006e\u0073\u002f\u0066\u0069\u0065\u006c\u0064\u0023",nil );
);func init (){_ffb .Register (Namespace ,_ffb .XmpMetadata );_ffb .Register (SchemaNS );_ffb .Register (PropertyNS );_ffb .Register (ValueTypeNS );_ffb .Register (FieldNS );};

// Namespaces implements xmp.Model interface.
func (_cf *Model )Namespaces ()_ffb .NamespaceList {return _ffb .NamespaceList {Namespace }};

// ValueTypes is the slice of field value types.
type ValueTypes []FieldValueType ;

// CanTag implements xmp.Model interface.
func (_edd *Model )CanTag (tag string )bool {_ ,_dgc :=_ffb .GetNativeField (_edd ,tag );return _dgc ==nil ;};

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_bde *ValueTypes )UnmarshalXMP (d *_ffb .Decoder ,node *_ffb .Node ,m _ffb .Model )error {return _ffb .UnmarshalArray (d ,node ,_bde .Typ (),_bde );};

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_ged *Schemas )UnmarshalXMP (d *_ffb .Decoder ,node *_ffb .Node ,m _ffb .Model )error {return _ffb .UnmarshalArray (d ,node ,_ged .Typ (),_ged );};

// SyncModel implements xmp.Model interface.
func (_bc *Model )SyncModel (d *_ffb .Document )error {return nil };var FieldVersionSchema =Schema {NamespaceURI :"\u0068\u0074\u0074p\u003a\u002f\u002f\u006e\u0073\u002e\u0061\u0064\u006f\u0062\u0065\u002e\u0063\u006f\u006d\u002f\u0078\u0061\u0070\u002f\u0031\u002e\u0030\u002f\u0073\u0054\u0079\u0070\u0065/\u0056\u0065\u0072\u0073\u0069\u006f\u006e\u0023",Prefix :"\u0073\u0074\u0056e\u0072",Schema :"\u0042a\u0073\u0069\u0063\u0020\u0076\u0061\u006c\u0075\u0065\u0020\u0074y\u0070\u0065\u0020\u0056\u0065\u0072\u0073\u0069\u006f\u006e",Property :[]Property {{Category :PropertyCategoryInternal ,Description :"\u0043\u006fmm\u0065\u006e\u0074s\u0020\u0063\u006f\u006ecer\u006ein\u0067\u0020\u0077\u0068\u0061\u0074\u0020wa\u0073\u0020\u0063\u0068\u0061\u006e\u0067e\u0064",Name :"\u0063\u006f\u006d\u006d\u0065\u006e\u0074\u0073",ValueType :ValueTypeNameText },{Category :PropertyCategoryInternal ,Description :"\u0048\u0069\u0067\u0068\u0020\u006c\u0065\u0076\u0065\u006c\u002c\u0020\u0066\u006f\u0072\u006d\u0061\u006c\u0020\u0064e\u0073\u0063\u0072\u0069\u0070\u0074\u0069\u006f\u006e\u0020\u006f\u0066\u0020\u0077\u0068\u0061\u0074\u0020\u006f\u0070\u0065r\u0061\u0074\u0069\u006f\u006e\u0020\u0074\u0068\u0065\u0020\u0075\u0073\u0065\u0072 \u0070\u0065\u0072f\u006f\u0072\u006d\u0065\u0064\u002e",Name :"\u0065\u0076\u0065n\u0074",ValueType :ValueTypeResourceEvent },{Category :PropertyCategoryInternal ,Description :"\u0054\u0068e\u0020\u0064\u0061\u0074\u0065\u0020\u006f\u006e\u0020\u0077\u0068\u0069\u0063\u0068\u0020\u0074\u0068\u0069\u0073\u0020\u0076\u0065\u0072\u0073\u0069\u006f\u006e\u0020\u0077\u0061\u0073\u0020\u0063\u0068\u0065\u0063\u006b\u0065\u0064\u0020\u0069\u006e\u002e",Name :"\u006d\u006f\u0064\u0069\u0066\u0079\u0044\u0061\u0074\u0065",ValueType :ValueTypeNameDate },{Category :PropertyCategoryInternal ,Description :"\u0054\u0068e\u0020\u0070\u0065\u0072s\u006f\u006e \u0077\u0068\u006f\u0020\u006d\u006f\u0064\u0069f\u0069\u0065\u0064\u0020\u0074\u0068\u0069\u0073\u0020\u0076\u0065\u0072s\u0069\u006f\u006e\u002e",Name :"\u006d\u006f\u0064\u0069\u0066\u0069\u0065\u0072",ValueType :ValueTypeNameProperName },{Category :PropertyCategoryInternal ,Description :"\u0054\u0068\u0065 n\u0065\u0077\u0020\u0076\u0065\u0072\u0073\u0069\u006f\u006e\u0020\u006e\u0075\u006d\u0062\u0065\u0072\u002e",Name :"\u0076e\u0072\u0073\u0069\u006f\u006e",ValueType :ValueTypeNameText }},ValueType :nil };


// SetTag implements xmp.Model interface.
func (_gf *Model )SetTag (tag ,value string )error {if _cd :=_ffb .SetNativeField (_gf ,tag ,value );_cd !=nil {return _b .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_cd );};return nil ;};

// Typ gets array type of the field value types.
func (_aaf ValueTypes )Typ ()_ffb .ArrayType {return _ffb .ArrayTypeOrdered };

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_fc *Properties )UnmarshalXMP (d *_ffb .Decoder ,node *_ffb .Node ,m _ffb .Model )error {return _ffb .UnmarshalArray (d ,node ,_fc .Typ (),_fc );};

// Schemas is the array of xmp metadata extension resources.
type Schemas []Schema ;

// MarshalXMP implements xmp.Marshaler interface.
func (_fg Schemas )MarshalXMP (e *_ffb .Encoder ,node *_ffb .Node ,m _ffb .Model )error {return _ffb .MarshalArray (e ,node ,_fg .Typ (),_fg );};const (ValueTypeResourceEvent ValueTypeName ="\u0052\u0065\u0073\u006f\u0075\u0072\u0063\u0065\u0045\u0076\u0065\u006e\u0074";
);

// GetTag implements xmp.Model interface.
func (_aaee *Model )GetTag (tag string )(string ,error ){_ebe ,_ffa :=_ffb .GetNativeField (_aaee ,tag );if _ffa !=nil {return "",_b .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_ffa );};return _ebe ,nil ;};

// SetSchema sets the schema into given model.
func (_cga *Model )SetSchema (namespaceURI string ,s Schema ){for _gad :=0;_gad < len (_cga .Schemas );_gad ++{if _cga .Schemas [_gad ].NamespaceURI ==namespaceURI {_cga .Schemas [_gad ]=s ;return ;};};_cga .Schemas =append (_cga .Schemas ,s );};func init (){_eg =map[string ]*Schema {_g .NsXmpMM .URI :&XmpMediaManagementSchema ,"\u0078\u006d\u0070\u0069\u0064\u0071":&XmpIDQualSchema ,_bf .NsPDF .URI :&PdfSchema ,"\u0073\u0074\u0045v\u0074":&FieldResourceEventSchema ,"\u0073\u0074\u0056e\u0072":&FieldVersionSchema };
...
ValueType ValueTypes `xmp:"pdfaSchema:valueType"`;};func _bd (_dbf _ffb .Model ,_df *_ffb .Namespace ,_dab Property )bool {_dbd :=_d .ValueOf (_dbf ).Elem ();if _dbd .Kind ()==_d .Ptr {_dbd =_dbd .Elem ();};_ad :=_dbd .Type ();for _cg :=0;_cg < _ad .NumField ();
_cg ++{_efa :=_ad .Field (_cg );_cb :=_efa .Tag .Get ("\u0078\u006d\u0070");if _cb ==""{continue ;};if !_ff .HasPrefix (_cb ,_df .Name ){continue ;};_bfb :=_ff .IndexRune (_cb ,':');if _bfb ==-1{continue ;};_ge :=_cb [_bfb +1:];if _ge ==_dab .Name {_ed :=_dbd .Field (_cg );
return !_ed .IsZero ();};};return false ;};
...
func FillModel (d *_ffb .Document ,extModel *Model )error {var _c []*_ffb .Namespace ;for _ ,_da :=range d .Namespaces (){_c =append (_c ,_da );};_a .Slice (_c ,func (_aab ,_gg int )bool {return _c [_aab ].Name < _c [_gg ].Name });for _ ,_ae :=range _c {switch _ae {case Namespace ,SchemaNS ,PropertyNS ,ValueTypeNS ,FieldNS ,_gd .NsXmp ,_dg .NsDc :continue ;
default:_ea ,_gc :=GetSchema (_ae .URI );if !_gc {continue ;};_fe :=d .FindModel (_ae );_ce :=*_ea ;_ce .Property =Properties {};for _ ,_ba :=range _ea .Property {_bg :=_bd (_fe ,_ae ,_ba );if _bg {_ce .Property =append (_ce .Property ,_ba );};};if len (_ce .Property )==0{continue ;
};var _aag bool ;for _ef ,_ga :=range extModel .Schemas {if _ga .Schema ==_ce .Schema {_aag =true ;extModel .Schemas [_ef ]=_ce ;break ;};};if !_aag {extModel .Schemas =append (extModel .Schemas ,_ce );};};};return nil ;};func (_fb Schemas )Typ ()_ffb .ArrayType {return _ffb .ArrayTypeUnordered };
var (_eg =map[string ]*Schema {};_ada _e .RWMutex ;);
...
func (_cea Schemas )IsZero ()bool {return len (_cea )==0};
...
func (_cba *Model )SyncFromXMP (d *_ffb .Document )error {return nil };
...
func MakeModel (d *_ffb .Document )(*Model ,error ){_db ,_ag :=d .MakeModel (Namespace );if _ag !=nil {return nil ,_ag ;};return _db .(*Model ),nil ;};
...
func NewModel (name string )_ffb .Model {return &Model {}};

// Model is the pdfa extension metadata model.
type Model struct{Schemas Schemas `xmp:"pdfaExtension:schemas"`;};

// MarshalXMP implements xmp.Marshaler interface.
func (_eae ValueTypes )MarshalXMP (e *_ffb .Encoder ,node *_ffb .Node ,m _ffb .Model )error {return _ffb .MarshalArray (e ,node ,_eae .Typ (),_eae );};const (ValueTypeNameBoolean ValueTypeName ="\u0042o\u006f\u006c\u0065\u0061\u006e";ValueTypeNameDate ValueTypeName ="\u0044\u0061\u0074\u0065";
...
func (_cfd *PropertyCategory )UnmarshalText (in []byte )error {switch string (in ){case "\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c":*_cfd =PropertyCategoryInternal ;case "\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c":*_cfd =PropertyCategoryExternal ;
default:*_cfd =PropertyCategoryUndefined ;};return nil ;};
...
func (_fea *Model )SyncToXMP (d *_ffb .Document )error {return nil };

// GetSchema for provided namespace.
func GetSchema (namespaceURI string )(*Schema ,bool ){_ada .RLock ();defer _ada .RUnlock ();_cff ,_ede :=_eg [namespaceURI ];return _cff ,_ede ;};

// Can implements xmp.Model interface.
func (_eb *Model )Can (nsName string )bool {return Namespace .GetName ()==nsName };

// MarshalText implements encoding.TextMarshaler interface.
func (_efg PropertyCategory )MarshalText ()([]byte ,error ){switch _efg {case PropertyCategoryInternal :return []byte ("\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;case PropertyCategoryExternal :return []byte ("\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;
case PropertyCategoryUndefined :return []byte (""),nil ;default:return nil ,_b .Errorf ("\u0075\u006ed\u0065\u0066\u0069\u006ee\u0064\u0020p\u0072\u006f\u0070\u0065\u0072\u0074\u0079\u0020c\u0061\u0074\u0065\u0067\u006f\u0072\u0079\u0020\u0076\u0061\u006c\u0075e\u003a\u0020\u0025\u0076",_efg );
