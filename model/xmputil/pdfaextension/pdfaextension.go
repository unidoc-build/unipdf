...
package pdfaextension ;import (_b "fmt";_a "github.com/trimmer-io/go-xmp/models/dc";_d "github.com/trimmer-io/go-xmp/models/pdf";_bb "github.com/trimmer-io/go-xmp/models/xmp_base";_ag "github.com/trimmer-io/go-xmp/models/xmp_mm";_cc "github.com/trimmer-io/go-xmp/xmp";
_f "reflect";_g "sort";_cd "strings";_e "sync";);

// FieldValueType is a schema that describes a field in a structured type.
type FieldValueType struct{Name string `xmp:"pdfaField:description"`;Description string `xmp:"pdfaField:name"`;ValueType ValueTypeName `xmp:"pdfaField:valueType"`;};func init (){_cc .Register (Namespace ,_cc .XmpMetadata );_cc .Register (SchemaNS );_cc .Register (PropertyNS );
_cc .Register (ValueTypeNS );_cc .Register (FieldNS );};

// GetTag implements xmp.Model interface.
func (_bab *Model )GetTag (tag string )(string ,error ){_be ,_dab :=_cc .GetNativeField (_bab ,tag );if _dab !=nil {return "",_b .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_dab );};return _be ,nil ;};

// IsZero checks if the resources list has no entries.
func (_bfd Schemas )IsZero ()bool {return len (_bfd )==0};

// MarshalXMP implements xmp.Marshaler interface.
func (_cdg Properties )MarshalXMP (e *_cc .Encoder ,node *_cc .Node ,m _cc .Model )error {return _cc .MarshalArray (e ,node ,_cdg .Typ (),_cdg );};
...
func GetSchema (namespaceURI string )(*Schema ,bool ){_de .RLock ();defer _de .RUnlock ();_ga ,_ebf :=_bf [namespaceURI ];return _ga ,_ebf ;};

// SyncFromXMP implements xmp.Model interface.
func (_aeb *Model )SyncFromXMP (d *_cc .Document )error {return nil };

// MakeModel creates or gets a model from document.
func MakeModel (d *_cc .Document )(*Model ,error ){_ae ,_bbe :=d .MakeModel (Namespace );if _bbe !=nil {return nil ,_bbe ;};return _ae .(*Model ),nil ;};

// SyncToXMP implements xmp.Model interface.
func (_dg *Model )SyncToXMP (d *_cc .Document )error {return nil };var XmpIDQualSchema =Schema {NamespaceURI :"\u0068t\u0074\u0070:\u002f\u002f\u006e\u0073.\u0061\u0064\u006fb\u0065\u002e\u0063\u006f\u006d\u002f\u0078\u006d\u0070/I\u0064\u0065\u006et\u0069\u0066i\u0065\u0072\u002f\u0071\u0075\u0061l\u002f\u0031.\u0030\u002f",Prefix :"\u0078\u006d\u0070\u0069\u0064\u0071",Schema :"X\u004dP\u0020\u0078\u006d\u0070\u0069\u0064\u0071\u0020q\u0075\u0061\u006c\u0069fi\u0065\u0072",Property :[]Property {{Category :PropertyCategoryInternal ,Name :"\u0053\u0063\u0068\u0065\u006d\u0065",Description :"\u0041\u0020\u0071\u0075\u0061\u006c\u0069\u0066\u0069\u0065\u0072\u0020\u0070\u0072o\u0076\u0069\u0064i\u006e\u0067\u0020\u0074h\u0065\u0020\u006e\u0020\u0061\u006d\u0065\u0020\u006f\u0066\u0020\u0074\u0068\u0065\u0020\u0066\u006f\u0072\u006d\u0061\u006c \u0069\u0064\u0065n\u0074\u0069\u0066\u0069\u0063\u0061\u0074\u0069\u006f\u006e\u0020\u0073\u0063\u0068\u0065\u006d\u0065\u0020\u0075\u0073ed\u0020\u0066\u006fr\u0020\u0061\u006e\u0020\u0069\u0074\u0065\u006d \u0069\u006e\u0020\u0074\u0068\u0065\u0020\u0078\u006d\u0070\u003a\u0049\u0064\u0065\u006e\u0074\u0069\u0066\u0069\u0065\u0072\u0020\u0061\u0072\u0072\u0061\u0079\u002e",ValueType :ValueTypeNameText }},ValueType :nil };


// Can implements xmp.Model interface.
func (_dacd *Model )Can (nsName string )bool {return Namespace .GetName ()==nsName };

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_gdf *ValueTypes )UnmarshalXMP (d *_cc .Decoder ,node *_cc .Node ,m _cc .Model )error {return _cc .UnmarshalArray (d ,node ,_gdf .Typ (),_gdf );};const (PropertyCategoryUndefined PropertyCategory =iota ;PropertyCategoryInternal ;PropertyCategoryExternal ;
);var (_bf =map[string ]*Schema {};_de _e .RWMutex ;);

// MarshalXMP implements xmp.Marshaler interface.
func (_gf ValueTypes )MarshalXMP (e *_cc .Encoder ,node *_cc .Node ,m _cc .Model )error {return _cc .MarshalArray (e ,node ,_gf .Typ (),_gf );};var FieldResourceEventSchema =Schema {NamespaceURI :"\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u006es\u002e\u0061\u0064ob\u0065\u002e\u0063\u006f\u006d\u002fx\u0061\u0070\u002f\u0031\u002e\u0030\u002f\u0073\u0054\u0079\u0070\u0065\u002f\u0052\u0065s\u006f\u0075\u0072\u0063\u0065\u0045\u0076\u0065n\u0074\u0023",Prefix :"\u0073\u0074\u0045v\u0074",Schema :"\u0044e\u0066\u0069n\u0069\u0074\u0069\u006fn\u0020\u006f\u0066 \u0062\u0061\u0073\u0069\u0063\u0020\u0076\u0061\u006cue\u0020\u0074\u0079p\u0065\u0020R\u0065\u0073\u006f\u0075\u0072\u0063e\u0045\u0076e\u006e\u0074",Property :[]Property {{Category :PropertyCategoryInternal ,Description :"\u0054he\u0020a\u0063t\u0069\u006f\u006e\u0020\u0074\u0068a\u0074\u0020\u006f\u0063c\u0075\u0072\u0072\u0065\u0064\u002e\u0020\u0044\u0065\u0066\u0069\u006e\u0065d \u0076\u0061\u006c\u0075\u0065\u0073\u0020\u0061\u0072\u0065\u003a\u0020\u0063\u006f\u006e\u0076\u0065\u0072\u0074\u0065d\u002c \u0063\u006f\u0070\u0069\u0065\u0064\u002c\u0020\u0063\u0072\u0065\u0061\u0074e\u0064\u002c \u0063\u0072\u006fp\u0070\u0065\u0064\u002c\u0020\u0065\u0064\u0069\u0074ed\u002c\u0020\u0066i\u006c\u002d\u0074\u0065r\u0065\u0064\u002c\u0020\u0066\u006fr\u006d\u0061t\u0074\u0065\u0064\u002c\u0020\u0076\u0065\u0072s\u0069\u006f\u006e\u005f\u0075\u0070\u0064\u0061\u0074\u0065\u0064\u002c\u0020\u0070\u0072\u0069\u006e\u0074\u0065\u0064\u002c\u0020\u0070ubli\u0073\u0068\u0065\u0064\u002c\u0020\u006d\u0061\u006e\u0061\u0067\u0065\u0064\u002c\u0020\u0070\u0072\u006f\u0064\u0075\u0063\u0065\u0064\u002c\u0020\u0072\u0065\u0073i\u007ae\u0064.\u004e\u0065\u0077\u0020\u0076\u0061\u006c\u0075\u0065\u0073\u0020\u0073\u0068\u006f\u0075\u006c\u0064\u0020\u0062\u0065 \u0076\u0065r\u0062\u0073 \u0069n\u0020\u0074\u0068\u0065\u0020\u0070a\u0073\u0074\u0020\u0074\u0065\u006e\u0073\u0065\u002e",Name :"\u0061\u0063\u0074\u0069\u006f\u006e",ValueType :"O\u0070\u0065\u006e\u0020\u0043\u0068\u006f\u0069\u0063\u0065"},{Category :PropertyCategoryInternal ,Description :"T\u0068\u0065\u0020\u0069\u006e\u0073\u0074\u0061\u006e\u0063\u0065\u0020\u0049\u0044\u0020\u006f\u0066\u0020t\u0068\u0065\u0020\u006d\u006f\u0064\u0069\u0066\u0069\u0065d \u0072\u0065\u0073o\u0075r\u0063\u0065",Name :"\u0069\u006e\u0073\u0074\u0061\u006e\u0063\u0065\u0049\u0044",ValueType :ValueTypeNameURI },{Category :PropertyCategoryInternal ,Description :"\u0041\u0064di\u0074\u0069\u006fn\u0061\u006c\u0020\u0064esc\u0072ip\u0074\u0069\u006f\u006e\u0020\u006f\u0066 t\u0068\u0065\u0020\u0061\u0063\u0074\u0069o\u006e",Name :"\u0070\u0061\u0072\u0061\u006d\u0065\u0074\u0065\u0072\u0073",ValueType :ValueTypeNameText },{Category :PropertyCategoryInternal ,Description :"\u0054h\u0065\u0020s\u006f\u0066\u0074\u0077a\u0072\u0065\u0020a\u0067\u0065\u006e\u0074\u0020\u0074\u0068\u0061\u0074 p\u0065\u0072\u0066o\u0072\u006de\u0064\u0020\u0074\u0068\u0065\u0020a\u0063\u0074i\u006f\u006e",Name :"\u0073\u006f\u0066\u0074\u0077\u0061\u0072\u0065\u0041\u0067\u0065\u006e\u0074",ValueType :ValueTypeNameAgentName },{Category :PropertyCategoryInternal ,Description :"\u004f\u0070t\u0069\u006f\u006e\u0061\u006c\u0020\u0074\u0069\u006d\u0065\u0073\u0074\u0061\u006d\u0070\u0020\u006f\u0066\u0020\u0077\u0068\u0065\u006e\u0020\u0074\u0068\u0065\u0020\u0061\u0063\u0074\u0069\u006f\u006e\u0020\u006f\u0063\u0063\u0075\u0072\u0072\u0065\u0064",Name :"\u0077\u0068\u0065\u006e",ValueType :ValueTypeNameDate }},ValueType :nil };
func init (){_bf =map[string ]*Schema {_ag .NsXmpMM .URI :&XmpMediaManagementSchema ,"\u0078\u006d\u0070\u0069\u0064\u0071":&XmpIDQualSchema ,_d .NsPDF .URI :&PdfSchema ,"\u0073\u0074\u0045v\u0074":&FieldResourceEventSchema ,"\u0073\u0074\u0056e\u0072":&FieldVersionSchema };
};

// RegisterSchema registers schema extension definition.
func RegisterSchema (ns *_cc .Namespace ,schema *Schema ){_de .Lock ();defer _de .Unlock ();_bf [ns .URI ]=schema ;};

// MarshalXMP implements xmp.Marshaler interface.
func (_dbge Schemas )MarshalXMP (e *_cc .Encoder ,node *_cc .Node ,m _cc .Model )error {return _cc .MarshalArray (e ,node ,_dbge .Typ (),_dbge );};

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_cf *Schemas )UnmarshalXMP (d *_cc .Decoder ,node *_cc .Node ,m _cc .Model )error {return _cc .UnmarshalArray (d ,node ,_cf .Typ (),_cf );};

// Typ gets array type of the field value types.
func (_ad ValueTypes )Typ ()_cc .ArrayType {return _cc .ArrayTypeOrdered };

// NewModel creates a new pdfAExtension model.
func NewModel (name string )_cc .Model {return &Model {}};func _dff (_fg _cc .Model ,_afe *_cc .Namespace ,_ed Property )bool {_fef :=_f .ValueOf (_fg ).Elem ();if _fef .Kind ()==_f .Ptr {_fef =_fef .Elem ();};_dac :=_fef .Type ();for _edb :=0;_edb < _dac .NumField ();
_edb ++{_dbg :=_dac .Field (_edb );_ge :=_dbg .Tag .Get ("\u0078\u006d\u0070");if _ge ==""{continue ;};if !_cd .HasPrefix (_ge ,_afe .Name ){continue ;};_dbe :=_cd .IndexRune (_ge ,':');if _dbe ==-1{continue ;};_aad :=_ge [_dbe +1:];if _aad ==_ed .Name {_bd :=_fef .Field (_edb );
return !_bd .IsZero ();};};return false ;};
...
// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_efc *Properties )UnmarshalXMP (d *_cc .Decoder ,node *_cc .Node ,m _cc .Model )error {return _cc .UnmarshalArray (d ,node ,_efc .Typ (),_efc );};

// Properties is a list of properties.
type Properties []Property ;

// CanTag implements xmp.Model interface.
func (_ef *Model )CanTag (tag string )bool {_ ,_feb :=_cc .GetNativeField (_ef ,tag );return _feb ==nil ;};

// FillModel fills in the document XMP model.
func FillModel (d *_cc .Document ,extModel *Model )error {var _da []*_cc .Namespace ;for _ ,_fe :=range d .Namespaces (){_da =append (_da ,_fe );};_g .Slice (_da ,func (_eg ,_aa int )bool {return _da [_eg ].Name < _da [_aa ].Name });for _ ,_af :=range _da {switch _af {case Namespace ,SchemaNS ,PropertyNS ,ValueTypeNS ,FieldNS ,_bb .NsXmp ,_a .NsDc :continue ;
default:_df ,_aga :=GetSchema (_af .URI );if !_aga {continue ;};_egb :=d .FindModel (_af );_bg :=*_df ;_bg .Property =Properties {};for _ ,_gd :=range _df .Property {_ccb :=_dff (_egb ,_af ,_gd );if _ccb {_bg .Property =append (_bg .Property ,_gd );};};
if len (_bg .Property )==0{continue ;};var _eb bool ;for _ce ,_ba :=range extModel .Schemas {if _ba .Schema ==_bg .Schema {_eb =true ;extModel .Schemas [_ce ]=_bg ;break ;};};if !_eb {extModel .Schemas =append (extModel .Schemas ,_bg );};};};return nil ;
};var (Namespace =_cc .NewNamespace ("\u0070\u0064\u0066\u0061\u0045\u0078\u0074\u0065\u006e\u0073\u0069\u006f\u006e","\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067\u002f\u0070\u0064\u0066\u0061/\u006e\u0073\u002f\u0065\u0078t\u0065\u006es\u0069\u006f\u006e\u002f",NewModel );
...
func (_dgg *Model )SyncModel (d *_cc .Document )error {return nil };

// Namespaces implements xmp.Model interface.
func (_bc *Model )Namespaces ()_cc .NamespaceList {return _cc .NamespaceList {Namespace }};

// ValueTypeName is the name of the value type.
type ValueTypeName string ;const (ValueTypeNameBoolean ValueTypeName ="\u0042o\u006f\u006c\u0065\u0061\u006e";ValueTypeNameDate ValueTypeName ="\u0044\u0061\u0074\u0065";ValueTypeNameInteger ValueTypeName ="\u0049n\u0074\u0065\u0067\u0065\u0072";ValueTypeNameReal ValueTypeName ="\u0052\u0065\u0061\u006c";
