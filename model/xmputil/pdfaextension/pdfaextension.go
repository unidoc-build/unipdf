...
package pdfaextension ;import (_c "fmt";_b "github.com/trimmer-io/go-xmp/models/dc";_gb "github.com/trimmer-io/go-xmp/models/pdf";_bd "github.com/trimmer-io/go-xmp/models/xmp_base";_cgb "github.com/trimmer-io/go-xmp/models/xmp_mm";_aa "github.com/trimmer-io/go-xmp/xmp";
_cg "reflect";_a "sort";_d "strings";_g "sync";);func (_feb Schemas )Typ ()_aa .ArrayType {return _aa .ArrayTypeUnordered };func init (){_aa .Register (Namespace ,_aa .XmpMetadata );_aa .Register (SchemaNS );_aa .Register (PropertyNS );_aa .Register (ValueTypeNS );
_aa .Register (FieldNS );};var FieldVersionSchema =Schema {NamespaceURI :"\u0068\u0074\u0074p\u003a\u002f\u002f\u006e\u0073\u002e\u0061\u0064\u006f\u0062\u0065\u002e\u0063\u006f\u006d\u002f\u0078\u0061\u0070\u002f\u0031\u002e\u0030\u002f\u0073\u0054\u0079\u0070\u0065/\u0056\u0065\u0072\u0073\u0069\u006f\u006e\u0023",Prefix :"\u0073\u0074\u0056e\u0072",Schema :"\u0042a\u0073\u0069\u0063\u0020\u0076\u0061\u006c\u0075\u0065\u0020\u0074y\u0070\u0065\u0020\u0056\u0065\u0072\u0073\u0069\u006f\u006e",Property :[]Property {{Category :PropertyCategoryInternal ,Description :"\u0043\u006fmm\u0065\u006e\u0074s\u0020\u0063\u006f\u006ecer\u006ein\u0067\u0020\u0077\u0068\u0061\u0074\u0020wa\u0073\u0020\u0063\u0068\u0061\u006e\u0067e\u0064",Name :"\u0063\u006f\u006d\u006d\u0065\u006e\u0074\u0073",ValueType :ValueTypeNameText },{Category :PropertyCategoryInternal ,Description :"\u0048\u0069\u0067\u0068\u0020\u006c\u0065\u0076\u0065\u006c\u002c\u0020\u0066\u006f\u0072\u006d\u0061\u006c\u0020\u0064e\u0073\u0063\u0072\u0069\u0070\u0074\u0069\u006f\u006e\u0020\u006f\u0066\u0020\u0077\u0068\u0061\u0074\u0020\u006f\u0070\u0065r\u0061\u0074\u0069\u006f\u006e\u0020\u0074\u0068\u0065\u0020\u0075\u0073\u0065\u0072 \u0070\u0065\u0072f\u006f\u0072\u006d\u0065\u0064\u002e",Name :"\u0065\u0076\u0065n\u0074",ValueType :ValueTypeResourceEvent },{Category :PropertyCategoryInternal ,Description :"\u0054\u0068e\u0020\u0064\u0061\u0074\u0065\u0020\u006f\u006e\u0020\u0077\u0068\u0069\u0063\u0068\u0020\u0074\u0068\u0069\u0073\u0020\u0076\u0065\u0072\u0073\u0069\u006f\u006e\u0020\u0077\u0061\u0073\u0020\u0063\u0068\u0065\u0063\u006b\u0065\u0064\u0020\u0069\u006e\u002e",Name :"\u006d\u006f\u0064\u0069\u0066\u0079\u0044\u0061\u0074\u0065",ValueType :ValueTypeNameDate },{Category :PropertyCategoryInternal ,Description :"\u0054\u0068e\u0020\u0070\u0065\u0072s\u006f\u006e \u0077\u0068\u006f\u0020\u006d\u006f\u0064\u0069f\u0069\u0065\u0064\u0020\u0074\u0068\u0069\u0073\u0020\u0076\u0065\u0072s\u0069\u006f\u006e\u002e",Name :"\u006d\u006f\u0064\u0069\u0066\u0069\u0065\u0072",ValueType :ValueTypeNameProperName },{Category :PropertyCategoryInternal ,Description :"\u0054\u0068\u0065 n\u0065\u0077\u0020\u0076\u0065\u0072\u0073\u0069\u006f\u006e\u0020\u006e\u0075\u006d\u0062\u0065\u0072\u002e",Name :"\u0076e\u0072\u0073\u0069\u006f\u006e",ValueType :ValueTypeNameText }},ValueType :nil };


// SyncFromXMP implements xmp.Model interface.
func (_bb *Model )SyncFromXMP (d *_aa .Document )error {return nil };

// FillModel fills in the document XMP model.
func FillModel (d *_aa .Document ,extModel *Model )error {var _bde []*_aa .Namespace ;for _ ,_gc :=range d .Namespaces (){_bde =append (_bde ,_gc );};_a .Slice (_bde ,func (_ggg ,_cd int )bool {return _bde [_ggg ].Name < _bde [_cd ].Name });for _ ,_gga :=range _bde {switch _gga {case Namespace ,SchemaNS ,PropertyNS ,ValueTypeNS ,FieldNS ,_bd .NsXmp ,_b .NsDc :continue ;
default:_gca ,_bg :=GetSchema (_gga .URI );if !_bg {continue ;};_bdec :=d .FindModel (_gga );_ba :=*_gca ;_ba .Property =Properties {};for _ ,_cge :=range _gca .Property {_gd :=_bf (_bdec ,_gga ,_cge );if _gd {_ba .Property =append (_ba .Property ,_cge );
};};if len (_ba .Property )==0{continue ;};var _fe bool ;for _bdf ,_df :=range extModel .Schemas {if _df .Schema ==_ba .Schema {_fe =true ;extModel .Schemas [_bdf ]=_ba ;break ;};};if !_fe {extModel .Schemas =append (extModel .Schemas ,_ba );};};};return nil ;
};
...
func (_ec *Model )SetSchema (namespaceURI string ,s Schema ){for _bc :=0;_bc < len (_ec .Schemas );_bc ++{if _ec .Schemas [_bc ].NamespaceURI ==namespaceURI {_ec .Schemas [_bc ]=s ;return ;};};_ec .Schemas =append (_ec .Schemas ,s );};const (PropertyCategoryUndefined PropertyCategory =iota ;
PropertyCategoryInternal ;PropertyCategoryExternal ;);var (_ge =map[string ]*Schema {};_efb _g .RWMutex ;);

// Namespaces implements xmp.Model interface.
func (_ef *Model )Namespaces ()_aa .NamespaceList {return _aa .NamespaceList {Namespace }};

// MarshalXMP implements xmp.Marshaler interface.
func (_ff ValueTypes )MarshalXMP (e *_aa .Encoder ,node *_aa .Node ,m _aa .Model )error {return _aa .MarshalArray (e ,node ,_ff .Typ (),_ff );};

// Properties is a list of properties.
type Properties []Property ;

// MarshalText implements encoding.TextMarshaler interface.
func (_gdc PropertyCategory )MarshalText ()([]byte ,error ){switch _gdc {case PropertyCategoryInternal :return []byte ("\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;case PropertyCategoryExternal :return []byte ("\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c"),nil ;
case PropertyCategoryUndefined :return []byte (""),nil ;default:return nil ,_c .Errorf ("\u0075\u006ed\u0065\u0066\u0069\u006ee\u0064\u0020p\u0072\u006f\u0070\u0065\u0072\u0074\u0079\u0020c\u0061\u0074\u0065\u0067\u006f\u0072\u0079\u0020\u0076\u0061\u006c\u0075e\u003a\u0020\u0025\u0076",_gdc );
};};

// GetTag implements xmp.Model interface.
func (_be *Model )GetTag (tag string )(string ,error ){_cdf ,_bdeg :=_aa .GetNativeField (_be ,tag );if _bdeg !=nil {return "",_c .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_bdeg );};return _cdf ,nil ;};
...
type PropertyCategory int ;func init (){_ge =map[string ]*Schema {_cgb .NsXmpMM .URI :&XmpMediaManagementSchema ,"\u0078\u006d\u0070\u0069\u0064\u0071":&XmpIDQualSchema ,_gb .NsPDF .URI :&PdfSchema ,"\u0073\u0074\u0045v\u0074":&FieldResourceEventSchema ,"\u0073\u0074\u0056e\u0072":&FieldVersionSchema };
};
...
func (_ad *Model )SetTag (tag ,value string )error {if _cgg :=_aa .SetNativeField (_ad ,tag ,value );_cgg !=nil {return _c .Errorf ("\u0025\u0073\u003a\u0020\u0025\u0076",Namespace .GetName (),_cgg );};return nil ;};
...
func GetSchema (namespaceURI string )(*Schema ,bool ){_efb .RLock ();defer _efb .RUnlock ();_aab ,_cb :=_ge [namespaceURI ];return _aab ,_cb ;};

// CanTag implements xmp.Model interface.
func (_dd *Model )CanTag (tag string )bool {_ ,_ccd :=_aa .GetNativeField (_dd ,tag );return _ccd ==nil ;};

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_cbf *Schemas )UnmarshalXMP (d *_aa .Decoder ,node *_aa .Node ,m _aa .Model )error {return _aa .UnmarshalArray (d ,node ,_cbf .Typ (),_cbf );};

// MarshalXMP implements xmp.Marshaler interface.
func (_dcf Schemas )MarshalXMP (e *_aa .Encoder ,node *_aa .Node ,m _aa .Model )error {return _aa .MarshalArray (e ,node ,_dcf .Typ (),_dcf );};
...
func (_ca Properties )Typ ()_aa .ArrayType {return _aa .ArrayTypeOrdered };var (Namespace =_aa .NewNamespace ("\u0070\u0064\u0066\u0061\u0045\u0078\u0074\u0065\u006e\u0073\u0069\u006f\u006e","\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067\u002f\u0070\u0064\u0066\u0061/\u006e\u0073\u002f\u0065\u0078t\u0065\u006es\u0069\u006f\u006e\u002f",NewModel );
SchemaNS =_aa .NewNamespace ("\u0070\u0064\u0066\u0061\u0053\u0063\u0068\u0065\u006d\u0061","h\u0074\u0074\u0070\u003a\u002f\u002fw\u0077\u0077\u002e\u0061\u0069\u0069m\u002e\u006f\u0072\u0067\u002f\u0070\u0064f\u0061\u002f\u006e\u0073\u002f\u0073\u0063\u0068\u0065\u006da\u0023",nil );
PropertyNS =_aa .NewNamespace ("\u0070\u0064\u0066a\u0050\u0072\u006f\u0070\u0065\u0072\u0074\u0079","\u0068\u0074t\u0070\u003a\u002f\u002fw\u0077\u0077.\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067/\u0070\u0064\u0066\u0061\u002f\u006e\u0073\u002f\u0070\u0072\u006f\u0070e\u0072\u0074\u0079\u0023",nil );
ValueTypeNS =_aa .NewNamespace ("\u0070\u0064\u0066\u0061\u0054\u0079\u0070\u0065","\u0068\u0074\u0074\u0070\u003a\u002f/\u0077\u0077\u0077\u002e\u0061\u0069\u0069\u006d\u002e\u006f\u0072\u0067\u002fp\u0064\u0066\u0061\u002f\u006e\u0073\u002ft\u0079\u0070\u0065\u0023",nil );
FieldNS =_aa .NewNamespace ("\u0070d\u0066\u0061\u0046\u0069\u0065\u006cd","\u0068\u0074\u0074p:\u002f\u002f\u0077\u0077\u0077\u002e\u0061\u0069\u0069m\u002eo\u0072g\u002fp\u0064\u0066\u0061\u002f\u006e\u0073\u002f\u0066\u0069\u0065\u006c\u0064\u0023",nil );
...
func (_cdd *Model )SyncModel (d *_aa .Document )error {return nil };

// Typ gets array type of the field value types.
func (_cdg ValueTypes )Typ ()_aa .ArrayType {return _aa .ArrayTypeOrdered };

// NewModel creates a new pdfAExtension model.
func NewModel (name string )_aa .Model {return &Model {}};
...
// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_ed *Properties )UnmarshalXMP (d *_aa .Decoder ,node *_aa .Node ,m _aa .Model )error {return _aa .UnmarshalArray (d ,node ,_ed .Typ (),_ed );};

// IsZero checks if the resources list has no entries.
func (_bca Schemas )IsZero ()bool {return len (_bca )==0};const (ValueTypeNameBoolean ValueTypeName ="\u0042o\u006f\u006c\u0065\u0061\u006e";ValueTypeNameDate ValueTypeName ="\u0044\u0061\u0074\u0065";ValueTypeNameInteger ValueTypeName ="\u0049n\u0074\u0065\u0067\u0065\u0072";
...
// MarshalXMP implements xmp.Marshaler interface.
func (_geb Properties )MarshalXMP (e *_aa .Encoder ,node *_aa .Node ,m _aa .Model )error {return _aa .MarshalArray (e ,node ,_geb .Typ (),_geb );};

// MakeModel creates or gets a model from document.
func MakeModel (d *_aa .Document )(*Model ,error ){_f ,_cc :=d .MakeModel (Namespace );if _cc !=nil {return nil ,_cc ;};return _f .(*Model ),nil ;};

// RegisterSchema registers schema extension definition.
func RegisterSchema (ns *_aa .Namespace ,schema *Schema ){_efb .Lock ();defer _efb .Unlock ();_ge [ns .URI ]=schema ;};

// SyncToXMP implements xmp.Model interface.
func (_af *Model )SyncToXMP (d *_aa .Document )error {return nil };
...
func (_bda *PropertyCategory )UnmarshalText (in []byte )error {switch string (in ){case "\u0069\u006e\u0074\u0065\u0072\u006e\u0061\u006c":*_bda =PropertyCategoryInternal ;case "\u0065\u0078\u0074\u0065\u0072\u006e\u0061\u006c":*_bda =PropertyCategoryExternal ;
default:*_bda =PropertyCategoryUndefined ;};return nil ;};

// Can implements xmp.Model interface.
func (_aac *Model )Can (nsName string )bool {return Namespace .GetName ()==nsName };func _bf (_ga _aa .Model ,_gbd *_aa .Namespace ,_gf Property )bool {_fc :=_cg .ValueOf (_ga ).Elem ();if _fc .Kind ()==_cg .Ptr {_fc =_fc .Elem ();};_eb :=_fc .Type ();
for _dca :=0;_dca < _eb .NumField ();_dca ++{_gbg :=_eb .Field (_dca );_fb :=_gbg .Tag .Get ("\u0078\u006d\u0070");if _fb ==""{continue ;};if !_d .HasPrefix (_fb ,_gbd .Name ){continue ;};_cf :=_d .IndexRune (_fb ,':');if _cf ==-1{continue ;};_gag :=_fb [_cf +1:];
if _gag ==_gf .Name {_ag :=_fc .Field (_dca );return !_ag .IsZero ();};};return false ;};

// UnmarshalXMP implements xmp.Unmarshaler interface.
func (_ab *ValueTypes )UnmarshalXMP (d *_aa .Decoder ,node *_aa .Node ,m _aa .Model )error {return _aa .UnmarshalArray (d ,node ,_ab .Typ (),_ab );};const (ValueTypeResourceEvent ValueTypeName ="\u0052\u0065\u0073\u006f\u0075\u0072\u0063\u0065\u0045\u0076\u0065\u006e\u0074";
