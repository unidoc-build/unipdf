...
func SetMeteredKeyPersistentCache (val bool ){_d .SetMeteredKeyPersistentCache (val )};const (LicenseTierUnlicensed =_d .LicenseTierUnlicensed ;LicenseTierCommunity =_d .LicenseTierCommunity ;LicenseTierIndividual =_d .LicenseTierIndividual ;LicenseTierBusiness =_d .LicenseTierBusiness ;
);
...
func SetLicenseKey (content string ,customerName string )error {return _d .SetLicenseKey (content ,customerName );};func SetMeteredKeyUsageLogVerboseMode (val bool ){_d .SetMeteredKeyUsageLogVerboseMode (val )};
