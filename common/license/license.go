...
package license ;import _a "github.com/unidoc/unipdf/v4/internal/license";

// LicenseKey represents a loaded license key.
type LicenseKey =_a .LicenseKey ;const (LicenseTierUnlicensed =_a .LicenseTierUnlicensed ;LicenseTierCommunity =_a .LicenseTierCommunity ;LicenseTierIndividual =_a .LicenseTierIndividual ;LicenseTierBusiness =_a .LicenseTierBusiness ;);
...
func SetLicenseKey (content string ,customerName string )error {return _a .SetLicenseKey (content ,customerName );};func SetMeteredKeyUsageLogVerboseMode (val bool ){_a .SetMeteredKeyUsageLogVerboseMode (val )};
